...
class SE_MobileNetV2_3x3(nn.Module):
    """
    Should freeze bn
    """
    def __init__(self, n_class=1000, input_size=224, width_mult=1.):
        super(SE_MobileNetV2_3x3, self).__init__()
        ...
        # building se layers
        self.se_block = []
        for channel in [16, 24, 32, 96, 320]:
            self.se_block.append(SEBlock(channel))
        self.se_block = nn.Sequential(*self.se_block)
